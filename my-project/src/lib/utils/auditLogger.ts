...
export type AuditAction =
  ...
  | 'SESSION_SCHEDULED' | 'SESSION_COMPLETED' | 'SESSION_REQUESTED'
  | 'MESSAGE_SENT' | 'NOTE_ADDED'
  | 'OPPORTUNITY_APPLIED' | 'CV_SAVED' | 'CV_UPDATED'
  | 'PROFILE_UPDATED' | 'USER_CREATED' | 'USER_UPDATED'
  | 'APPLICATION_SUBMITTED' | 'SETTINGS_UPDATED'
  | 'NOTIFICATION_READ' | 'SPEAKING_RECORDED';
