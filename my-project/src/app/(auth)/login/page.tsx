...
import { GraduationCap, Eye, EyeOff, ArrowRight, CheckCircle, Users, TrendingUp, Award } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-emerald-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="text-emerald-300 leading-relaxed">
              Thousands of Rwandan students are building their futures with EDU-Bridge every day.
            </p>
          </div>
          ...
          <div className="bg-white/10 border border-white/10 rounded-2xl p-6">
            ...
            <p className="text-emerald-100 text-sm leading-relaxed italic mb-4">
              &quot;EDU-Bridge gave me the English and digital skills I needed to apply for university.
              I got accepted — and it was completely free.&quot;
            </p>
            <div className="flex items-center gap-3">
              <img
                src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=48&h=48&fit=crop&crop=face"
                alt="Amina K."
                className="w-10 h-10 rounded-full object-cover ring-2 ring-emerald-600"
              />
              <div>
        ...
        <div className="relative z-10">
          <p className="text-emerald-500 text-xs">
            © {new Date().getFullYear()} EDU-Bridge · Free for all public day school students in Rwanda
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm">
              ...
              <Link href="/register" className="text-emerald-700 font-semibold hover:text-emerald-800 transition-colors">
                Create one free
              </Link>
            </p>
          </div>
            ...
            <div className="grid grid-cols-3 gap-2 bg-gray-100 p-1 rounded-xl">
              {(['student', 'mentor', 'admin'] as const).map((r) => (
                <button
                  key={r}
                  onClick={() => setRole(r)}
                  className={`py-2 text-sm font-semibold rounded-lg capitalize transition-all duration-200 ${
                    role === r
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/reset-password" className="text-xs text-emerald-700 hover:text-emerald-800 font-medium transition-colors">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="flex items-center gap-2">
              <input
                id="remember"
                type="checkbox"
                className="w-4 h-4 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500 accent-emerald-700"
              />
